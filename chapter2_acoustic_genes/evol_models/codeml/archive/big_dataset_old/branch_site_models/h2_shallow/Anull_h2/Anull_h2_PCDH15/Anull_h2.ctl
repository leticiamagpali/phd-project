      seqfile = ../../../../cml_align/codon-align-h2/PCDH15_codon_cml.phy                                             * Path to the alignment file
     treefile = ../../../../cml_trees/speciestrees-h2/PCDH15_tree_h2.phy                              * Path to the tree file
      outfile = out_Amodel_h2_PCDH15.txt                                                                  * Path to the output file
