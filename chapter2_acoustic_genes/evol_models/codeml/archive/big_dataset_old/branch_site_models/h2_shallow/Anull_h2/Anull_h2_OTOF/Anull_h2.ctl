      seqfile = ../../../../cml_align/codon-align-h2/OTOF_codon_cml.phy                                             * Path to the alignment file
     treefile = ../../../../cml_trees/speciestrees-h2/OTOF_tree_h2.phy                              * Path to the tree file
      outfile = out_Amodel_h2_OTOF.txt                                                                  * Path to the output file
