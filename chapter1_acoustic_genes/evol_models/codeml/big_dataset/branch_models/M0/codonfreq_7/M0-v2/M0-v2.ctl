      seqfile = ../../../cml_align/codon-align-v2-cml.phy                                    * Path to the alignment file
     treefile = ../../../cml_trees/speciestree-v2.phy                                        * Path to the tree file
      outfile = out_M0_v2.txt                                                                * Path to the output file
