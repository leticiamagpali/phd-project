      seqfile = ../../../cml_align/codon-align-h3v2-cml.phy                                    * Path to the alignment file
     treefile = ../../../cml_trees/speciestrees-h3v2.phy                                        * Path to the tree file
      outfile = out_Amodel_h3v2.txt                                                                * Path to the output file
   
        noisy = 3                     * How much rubbish on the screen
      verbose = 1                     * More or less detailed report

      seqtype = 1                      * Data type
        ndata = 4 separate_trees       * Number of data sets or loci
