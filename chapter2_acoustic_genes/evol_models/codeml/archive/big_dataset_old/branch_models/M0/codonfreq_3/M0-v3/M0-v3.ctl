      seqfile = ../../../../cml_align/codon-align-v3-cml.phy                                    * Path to the alignment file
     treefile = ../../../../cml_trees/speciestree-v3.phy                                        * Path to the tree file
      outfile = out_M0_v3.txt                                                                * Path to the output file
