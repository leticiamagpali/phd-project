function [LL,POST,revCW_site_likelihoods,LPM]  = likelihoodFun_rCW(paramVec,CM,TF,SEQI,pi_state,Y,dMap,dP,codestr)
...
ccCW = dMap; ccCW(dMap == 1) = r1CL; ccCW(dMap == 0) = r2CL; % rate ratios
...
revCW_site_likelihoods = sum(LCW.*repmat(dP(:),1,n_cod));
